...
export default function Post(props) {
  ...
  // console.log(post.imagesGallery);
  ...
  const imagesProps =
    post?.imagesGallery &&
    post?.imagesGallery.map(img => (img ? GetImage(img) : null));
        ...
        <Layout {...siteConfig}>
          ...
          <div className="">
            {imagesProps &&
              imagesProps.map(img => (
                <div
                  className="relative z-0 max-w-screen-lg mx-auto my-4 overflow-hidden lg:rounded-lg aspect-video"
                  key={img.index}>
                  <Image
                    src={img.src}
                    loader={img.loader}
                    blurDataURL={imagesProps.blurDataURL}
